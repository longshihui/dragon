...
> {
    ...
    removeValueFromCheckedUnselectedList(value: string) {
        this.setState(state => {
            return {
                checkedUnselectedList: remove(
                    state.checkedUnselectedList,
                    value
                )
            };
        });
    ...
    onSelectDirectory() {
        this.props.onChange(
            this.props.createDirectoryList.concat(
    ...
    onCancelSelectDirectory() {
        ...
        this.setState(state => {
            return {
                unselectedList: state.unselectedList.concat(
                    state.checkedSelectedList
                ),
                checkedSelectedList: []
            };
        });
                    ...
                    >
                        <Grid item>
                            <DirectoryList
                                ...
                                onRemoveChecked={value => {
                                    this.removeValueFromCheckedUnselectedList(
                                        value
                                    );
                                }}
                            />
                        ...
                        <Grid item>
                            <DirectoryList
                                ...
                                checkedDirectoryList={
                                    this.state.checkedSelectedList
                                }
                                onAddChecked={value => {
                                    this.addCheckedSelectedList(value);
                                }}
                                onRemoveChecked={value => {
                                    this.removeValueFromCheckedSelectedList(
                                        value
                                    );
                                }}
                            />
